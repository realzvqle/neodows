...
static inline void kend_kernel(){
    ...
    kputs(30, 31, "halting kernel", 1, 0x8B0101);
...
void kbug_check(char* error){
    ...
    kputs(20, 20, ":c", 3, 0xffffff);
    kputs(10, 10, "neokrnl has ran into an issue and has been shutdown to prevent damage", 1, 0xffffff);
    kputs(10, 11, "please contact zvqle with this error codes", 1, 0xffffff);
    kputs(10, 14, error, 1, 0xffffff);
